...
import { Injectable, EventEmitter, inject, ElementRef, NgZone, Component, ViewChild, Output, Input, NgModule } from '@angular/core';
import * as PDFJS from 'pdfjs-dist';
import { VerbosityLevel, GlobalWorkerOptions, getDocument } from 'pdfjs-dist';
import * as PDFJSViewer from 'pdfjs-dist/web/pdf_viewer.mjs';
import { fromEvent, BehaviorSubject, Subject, combineLatest, from } from 'rxjs';
